...
class DefaultClient {
    ...
    onRegisterCustomConfigurationProvider(provider) {
        return this.notifyWhenReady(() => {
            ...
            if (!selectedProvider) {
                ...
                this.configuration.addCustomConfigurationProvider(provider.extensionId);
            }
        });
    }
    ...
    provideCustomConfiguration(document) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.queueTaskWithTimeout(provideConfigurationAsync, 1000, tokenSource).then((configs) => {
