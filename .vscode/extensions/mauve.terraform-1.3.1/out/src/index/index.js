...
class Index {
    ...
    groupFor(uriOrFileIndexOrSection) {
        if (uriOrFileIndexOrSection instanceof section_1.Section)
            return this.groups.find(g => g.belongs(group_1.dirname(uriOrFileIndexOrSection.location.uri)));
        else
